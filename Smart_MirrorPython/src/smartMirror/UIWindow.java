...
public class UIWindow implements NewInfoFoundListener
{
	...
	private JLabel lblPIBackground;
	...
	private void addComponents()
	{
		...
		// add lblPIBackground
		lblPIBackground = new JLabel();
		ImageIcon piBackground = new ImageIcon(getClass().getResource("/resources/pibackground.png"));
		lblPIBackground.setIcon(piBackground);
		lblPIBackground.setLocation(10, screenSize.height - (10 +piBackground.getIconHeight()));
		lblPIBackground.setSize(piBackground.getIconWidth(), piBackground.getIconHeight());
		jlpBack.add(lblPIBackground, 1, 0);
